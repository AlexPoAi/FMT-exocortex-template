...
# Memory (Слой 3)
cp ~/.claude/projects/{{CLAUDE_PROJECT_SLUG}}/memory/MEMORY.md /Users/alexander/Github/DS-strategy/exocortex/MEMORY.md
cp ~/.claude/projects/{{CLAUDE_PROJECT_SLUG}}/memory/*.md /Users/alexander/Github/DS-strategy/exocortex/
```
