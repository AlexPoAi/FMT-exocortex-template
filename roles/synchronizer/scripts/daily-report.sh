...
RUNTIME_POLICY_FILE="$STRATEGY_DIR/current/RUNTIME-POLICY.env"
RUNTIME_MODE_FILE="$STRATEGY_DIR/current/RUNTIME-MODE.md"
...
build_session_open() {
    ...
    case "$(protocol_contract_status)" in
        ...
        missing)
            ...
            verdict_color="🔴 red"
            protocol_route_status="🔴 red"
            issues="${issues}- Canonical protocol route incomplete under $CANONICAL_MEMORY_DIR\n"
            ;;
    esac
