...
1. Прочитать `DS-strategy/current/WeekPlan W*.md` → «Рабочие продукты» текущей недели
2. Совпадает? → Да: п.3. Нет: шаг 2b.
2b. Не нашёл в WeekPlan → grep `DS-strategy/docs/WP-REGISTRY.md` (полный список). Нашёл → п.3. Не нашёл → СТОП.
