...
> Порядок: in_progress → pending → done. Обновлено: Week Review 2026-04-06.

| # | РП | Бюджет | Статус | Дедлайн |
|---|-----|--------|--------|---------|
| 51 | ПАРК: Аудит счетов от архитекторов | 2h | pending | — |
| 52 | КУХНЯ: Оценка и выбор вакуума тора | 2h | pending | — |
| 53 | КОФЕЙНИ: Аналитика через Saby | 3h | pending | — |
| 54 | КОФЕЙНИ: Маркетинговый агент — ТЗ | 2h | pending | — |
| 55 | KE-быстрые: routing gap + 3 метода IWE | 45m | pending | — |
| 56 | СИСТЕМА: Аудит Pack — gap-анализ | 3h | pending | — |
| 57 | СИСТЕМА: Реестры документов — REGISTRY.md | 2h | pending | — |
| 47 | Редизайн workflow Extractor | 3h | partial | — |
